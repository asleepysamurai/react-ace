  ...
  return (function(e) {
    ...
    function(e, t, i) {
      (function(e, i) {
        ...
        var V,
          ...
          X = G.toString,
          Q = q.hasOwnProperty,
          J = (V = /[^.]+$/.exec((Y && Y.keys && Y.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + V
            : "",
          Z = q.toString,
          ee = RegExp(
          ...
          te = O ? R.Buffer : void 0,
          ie = R.Symbol,
          ne = R.Uint8Array,
          se = q.propertyIsEnumerable,
          re = K.splice,
          oe = ie ? ie.toStringTag : void 0,
          ...
          return (
            ...
            (null == e || null == t || (!Xe(e) && !Xe(t))
              ...
              : (function(e, t, i, n, s, a) {
                      ...
                      c || Qe(e)
                        ...
                        : (function(e, t, i, n, s, a, l) {
                            switch (i) {
                              ...
                              case b:
                                var c = n & r;
                                if ((h || (h = N), e.size != t.size && !c))
                                  return !1;
                                var g = l.get(e);
                                if (g) return g == t;
                                (n |= o), l.set(e, t);
                                var p = Te(h(e), h(t), n, s, a, l);
                                return l.delete(e), p;
                              case y:
                  ...
                  if (!(i & r)) {
                    var k = w && Q.call(e, "__wrapped__"),
                      x = $ && Q.call(t, "__wrapped__");
                    if (k || x) {
                      var L = k ? e.value() : e,
                        _ = x ? t.value() : t;
                      return a || (a = new Be()), s(L, _, i, n, a);
                    }
                  }
                  if (!D) return !1;
                  return (
        ...
        function Re(e) {
          return (
            !(!Ye(e) || ((t = e), J && J in t)) && (Ge(e) ? ee : D).test(Ne(e))
          );
          var t;
        }
        function Me(e) {
          if (
            ((i = (t = e) && t.constructor),
            (n = ("function" == typeof i && i.prototype) || q),
            t !== n)
          )
            return he(e);
          var t,
          ...
          for (var r in Object(e))
            Q.call(e, r) && "constructor" != r && s.push(r);
          return s;
        }
        function Te(e, t, i, n, s, a) {
          ...
          for (a.set(e, t), a.set(t, e); ++d < h; ) {
            ...
            if (g) {
              if (
                !H(t, function(e, t) {
                  if (((r = t), !g.has(r) && (p === e || s(p, e, i, n, a))))
                    return g.push(t);
                  var r;
                })
              ) {
        ...
        (Ee.prototype.clear = function() {
          ...
          (ye.prototype.delete = function(e) {
            ...
            return !(
              i < 0 ||
              (i == t.length - 1 ? t.pop() : re.call(t, i, 1), --this.size, 0)
            );
          }),
        ...
        ((ce && He(new ce(new ArrayBuffer(1))) != B) ||
          (ue && He(new ue()) != m) ||
          (de && "[object Promise]" != He(de.resolve())) ||
          (fe && He(new fe()) != b) ||
          (ge && "[object WeakMap]" != He(new ge()))) &&
          (He = function(e) {
            var t = xe(e),
        ...
        var Qe = W
          ...
          : function(e) {
              return Xe(e) && qe(e.length) && !!x[xe(e)];
            };
        function Je(e) {
          return null != (t = e) && qe(t.length) && !Ge(t) ? De(e) : Me(e);
          var t;
        }
    ...
    function(e, t, i) {
      !(function() {
        ...
        (n = e),
          (i = "ace") && (e[i] || (e[i] = {}), (n = e[i])),
          (n.define && n.define.packaged) ||
            ((t.original = n.define), (n.define = t), (n.define.packaged = !0)),
          (n.acequire && n.acequire.packaged) ||
            ((r.original = n.acequire),
            (n.acequire = r),
            (n.acequire.packaged = !0));
      })(),
        ace.define("ace/lib/regexp", ["require", "exports", "module"], function(
          ...
          var n,
            ...
            o = ((n = /^/g), s.test.call(n, ""), !n.lastIndex);
          (o && r) ||
            ((RegExp.prototype.exec = function(e) {
              var t,
                i,
                n,
                a = s.exec.apply(this, arguments);
              if ("string" == typeof e && a) {
                if (
                  (!r &&
                    ...
                    s.replace.call(e.slice(a.index), i, function() {
                  ...
                  for (var l = 1; l < a.length; l++)
                    (t = this._xregexp.captureNames[l - 1]) && (a[t] = a[l]);
                !o &&
                  this.global &&
                  !a[0].length &&
        ...
        ace.define(
          ...
          function(e, t, i) {
            ...
            if (
              (Array.prototype.forEach ||
                (Array.prototype.forEach = function(e) {
                  var t = _(this),
                    i = C && "[object String]" == f(this) ? this.split("") : t,
                    n = arguments[1],
                    s = -1,
                    r = i.length >>> 0;
              ...
              Array.prototype.filter ||
                (Array.prototype.filter = function(e) {
                  var t,
                    i = _(this),
                    n = C && "[object String]" == f(this) ? this.split("") : i,
                    s = n.length >>> 0,
                    r = [],
                    o = arguments[1];
                  if ("[object Function]" != f(e))
            ...
            if (Object.defineProperty) {
              ...
              if (!F || !b) var E = Object.defineProperty;
            }
            ...
            if (
              ...
              var y = !0,
                ...
                S = $.length;
              for (var B in { toString: null }) y = !1;
              ...
              (this.onMouseDown = function(e) {
                ...
                (this.focusWait = function() {
                  var e,
                    ...
                    i,
                    n,
                    s = ((e = this.mousedownEvent.x),
                    (t = this.mousedownEvent.y),
                    (i = this.x),
                    (n = this.y),
                    Math.sqrt(Math.pow(i - e, 2) + Math.pow(n - t, 2))),
                    r = Date.now();
                  (s > 0 || r - this.mousedownEvent.time > this.$focusTimout) &&
        ...
        ace.define(
          ...
          function(e, t, n) {
            ...
            function h(s) {
              if (a && a.document) {
                l.packaged =
                  s || e.packaged || n.packaged || (a.define && i(6).packaged);
                for (
                  var r,
                    o = {},
                    h = "",
                ...
                for (var w in (h && ((o.base = o.base || h), (o.packaged = !0)),
                (o.basePath = o.base),
                  ...
                  (this.addSubFold = function(e) {
                    if (!this.range.isEqual(e)) {
                      ...
                      for (
                        ...
                        1 == (a = this.subFolds[r].range.compare(n, s));
                        r++
                      );
                      ...
                      for (
                        ...
                        1 == (a = this.subFolds[h].range.compare(n, s));
                        h++
                      );
                      this.subFolds[h];
                      if (0 == a)
                ...
                (this.drawTextMarker = function(e, t, i, s, r) {
                  for (
                    ...
                    (g.start.row = g.end.row = h),
                      (g.start.column =
                        h == a ? t.start.column : o.getRowWrapIndent(h)),
                      (g.end.column = d),
                      (c = u),
                      (u = d),
                      (d =
                        h + 1 < l
                          ? o.getScreenLastRowColumn(h + 1)
                          : h == l
                            ? 0
                            : t.end.column),
                      (f =
                ...
                (this.ranges = null),
                  ...
                  (this.rectangularRangeBlock = function(e, t, i) {
                    ...
                    if (d)
                      var f = e.row,
                        g = t.row;
                    else (f = t.row), (g = e.row);
                    o < 0 && (o = 0), f < 0 && (f = 0), f == g && (i = !0);
                    for (var p = f; p <= g; p++) {
                      var m = s.fromPoints(
                        this.session.screenToDocumentPosition(p, o, l),
                        this.session.screenToDocumentPosition(p, a, h)
                      );
                      if (m.isEmpty()) {
                        if (
                          A &&
                      ...
                      (m.cursor = r ? m.start : m.end), n.push(m);
                    }
                    if ((d && n.reverse(), !i)) {
                      for (var v = n.length - 1; n[v].isEmpty() && v > 0; ) v--;
                      if (v > 0) for (var C = 0; n[C].isEmpty(); ) C++;
                      for (var w = v; w >= C; w--)
                        n[w].isEmpty() && n.splice(w, 1);
                    }
                    return n;
                  });
              }.call(r.prototype));
    ...
    function(e, t, i) {
      ...
      i(16);
      var d = (0, r.getAceInstance)(),
        f = d.acequire("ace/range").Range,
        g = d.acequire("ace/split").Split,
        p = (function(e) {
          function t(e) {
            !(function(e, t) {
              if (!(e instanceof t))
            ...
            s(t, [
              {
                ...
                value: function() {
                  var e = this,
                    ...
                    y = t.markers,
                    $ = t.splits;
                  (this.editor = d.edit(this.refEditor)), n && n(d);
                  var S = Object.keys(this.props.editorProps),
                    B = new g(this.editor.container, "ace/theme/" + a, $);
                  (this.editor.env.split = B),
                    (this.splitEditor = B.getEditor(0)),
                    (this.split = B),
                  ...
                  this.props.debounceChangePeriod &&
                    ...
                    B.forEach(function(t, i) {
                      for (var n = 0; n < S.length; n++)
                        t[S[n]] = e.props.editorProps[S[n]];
                      var o = (0, c.default)(u, i),
                        g = (0, c.default)(h, i, "");
                      t.session.setUndoManager(new d.UndoManager()),
                        t.setTheme("ace/theme/" + a),
                        t.renderer.setScrollMargin(C[0], C[1], C[2], C[3]),
                        t.getSession().setMode("ace/mode/" + s),
                        t.setFontSize(l),
                        t.renderer.setShowGutter(p),
                        t.getSession().setUseWrapMode(m),
                        t.setShowPrintMargin(A),
                        ...
                        t.setValue(void 0 === o ? g : o, f);
                      var v = (0, c.default)(E, i, []),
                        F = (0, c.default)(y, i, []);
                      t.getSession().setAnnotations(v),
                        F && F.length > 0 && e.handleMarkers(F, t);
                      for (var $ = 0; $ < r.editorOptions.length; $++) {
                        var B = r.editorOptions[$];
                        D.hasOwnProperty(B)
                          ? t.setOption(B, e.props[B])
                          : e.props[B] &&
                            console.warn(
                      ...
                      e.handleOptions(e.props, t),
                        ...
                        w && t.setKeyboardHandler("ace/keyboard/" + w);
                    }),
                    i && (this.refEditor.className += " " + i),
                    o && this.splitEditor.focus();
                  var k = this.editor.env.split;
                  k.setOrientation(
                    "below" === this.props.orientation ? k.BELOW : k.BESIDE
                  ),
                    k.resize(!0),
                    F && F(k);
                }
                ...
                value: function(e) {
                  ...
                  if (
                    ...
                    s.forEach(function(e, s) {
                      ...
                      (0, h.default)(n.setOptions, i.setOptions) ||
                        t.handleOptions(n, e);
                      var l = (0, c.default)(n.value, s, "");
                      if (e.getValue() !== l) {
                        t.silent = !0;
                        var u = e.session.selection.toJSON();
                        e.setValue(l, n.cursorStart),
                          e.session.selection.fromJSON(u),
                          (t.silent = !1);
                      }
                      var d = (0, c.default)(n.annotations, s, []),
                        f = (0, c.default)(i.annotations, s, []);
                      (0, h.default)(d, f) || e.getSession().setAnnotations(d);
                      var g = (0, c.default)(n.markers, s, []),
                        p = (0, c.default)(i.markers, s, []);
                      !(0, h.default)(g, p) &&
                        Array.isArray(g) &&
                        t.handleMarkers(g, e);
                    }),
      ...
      (t.default = p),
        (p.propTypes = {
          ...
          splits: l.default.number,
          orientation: l.default.string,
          ...
          value: l.default.arrayOf(l.default.string),
          defaultValue: l.default.arrayOf(l.default.string),
    ...
    function(e, t, i) {
      ...
      var u = (0, h.getAceInstance)(),
        d = u.acequire("ace/range").Range,
        f = (function(e) {
          function t(e) {
            !(function(e, t) {
              if (!(e instanceof t))
            ...
            return (
              h.editorEvents.forEach(function(e) {
                i[e] = i[e].bind(i);
              }),
              (i.debounce = h.debounce),
              i
            );
          }
          return (
            ...
            s(t, [
              {
                ...
                value: function() {
                  ...
                  for (
                    var $ = Object.keys(this.props.editorProps), S = 0;
                    S < $.length;
                    S++
                  )
                    this.editor[$[S]] = this.props.editorProps[$[S]];
                  this.props.debounceChangePeriod &&
                    (this.onChange = this.debounce(
                      this.onChange,
                      this.props.debounceChangePeriod
                    ...
                    this.editor.getSession().setValue(d || c, f),
                    this.editor.navigateFileEnd(),
                    this.editor.renderer.setShowGutter(g),
                    this.editor.getSession().setUseWrapMode(p),
                    this.editor.setShowPrintMargin(m),
                    ...
                    y && this.updatePlaceholder(this.editor, y),
                    this.editor
                      .getSession()
                    ...
                    this.editor.getSession().setAnnotations(b || []),
                    E && E.length > 0 && this.handleMarkers(E);
                  for (
                    var B = this.editor.$options, D = 0;
                    D < h.editorOptions.length;
                    D++
                  ) {
                    var k = h.editorOptions[D];
                    B.hasOwnProperty(k)
                      ? this.editor.setOption(k, this.props[k])
                      : this.props[k] &&
                        console.warn(
                  ...
                  this.handleOptions(this.props),
                    ...
                    C && this.editor.setKeyboardHandler("ace/keyboard/" + C),
                    i && (this.refEditor.className += " " + i),
                    w && w(this.editor),
                    this.editor.resize(),
                    o && this.editor.focus();
              ...
              },
              {
                ...
                value: function(e) {
                  for (
                    ...
                    n < h.editorOptions.length;
                    n++
                  ) {
                    var s = h.editorOptions[n];
                  ...
                  i.placeholder !== t.placeholder && this.updatePlaceholder(),
                    ...
                    (0, l.default)(i.setOptions, t.setOptions) ||
                      this.handleOptions(i),
                    (0, l.default)(i.annotations, t.annotations) ||
                      this.editor
                        .getSession()
                        .setAnnotations(i.annotations || []),
                    !(0, l.default)(i.markers, t.markers) &&
                      Array.isArray(i.markers) &&
                      this.handleMarkers(i.markers),
                    (0, l.default)(i.scrollMargin, t.scrollMargin) ||
              ...
              },
              {
                ...
                value: function() {
                  ...
                  !i && n
                    ? (e.renderer.scroller.removeChild(
                        e.renderer.placeholderNode
                      ),
      ...
      (t.default = f),
        (f.propTypes = {
          ...
          fontSize: a.default.oneOfType([a.default.number, a.default.string]),
          showGutter: a.default.bool,
          onChange: a.default.func,
          onCopy: a.default.func,
          onPaste: a.default.func,
          onFocus: a.default.func,
          onInput: a.default.func,
          onBlur: a.default.func,
          onScroll: a.default.func,
          value: a.default.string,
          defaultValue: a.default.string,
          onLoad: a.default.func,
          onSelectionChange: a.default.func,
          onCursorChange: a.default.func,
          onBeforeLoad: a.default.func,
          onValidate: a.default.func,
          minLines: a.default.number,
          maxLines: a.default.number,
          ...
          debounceChangePeriod: a.default.number,
          editorProps: a.default.object,
          setOptions: a.default.object,
          style: a.default.object,
          scrollMargin: a.default.array,
          annotations: a.default.array,
          markers: a.default.array,
          keyboardHandler: a.default.string,
          wrapEnabled: a.default.bool,
          enableBasicAutocompletion: a.default.oneOfType([
            a.default.bool,
            a.default.array
          ]),
          enableLiveAutocompletion: a.default.oneOfType([
            a.default.bool,
            a.default.array
          ]),
          commands: a.default.array,
    ...
    function(e, t, i) {
       ...
       */ var n = i(11),
        ...
        d = s ? Symbol.for("react.concurrent_mode") : 60111,
        f = s ? Symbol.for("react.forward_ref") : 60112,
        g = s ? Symbol.for("react.suspense") : 60113,
        p = s ? Symbol.for("react.memo") : 60115,
        m = s ? Symbol.for("react.lazy") : 60116,
      ...
      (y.constructor = E), n(y, F.prototype), (y.isPureReactComponent = !0);
      var $ = { current: null },
        S = { current: null },
      ...
      function k(e, t, i) {
        ...
        if (null != t)
          ...
          t))
            B.call(t, n) && !D.hasOwnProperty(n) && (s[n] = t[n]);
              ...
              if (((l = 0), (i = "" === i ? "." : i + ":"), Array.isArray(t)))
                ...
                ((c =
                  null === t || "object" != typeof t
                    ? null
                    : "function" == typeof (c = (A && t[A]) || t["@@iterator"])
                      ? c
                      : null),
                "function" == typeof c)
              )
                for (t = c.call(t), h = 0; !(a = t.next()).done; )
                  l += e((a = a.value), (c = i + O(a, h++)), n, s);
              else
                "object" === a &&
                  v(
                    "31",
      ...
      var z = {
          ...
          cloneElement: function(e, t, i) {
            ...
            var s = void 0,
              ...
              h = e._owner;
            if (null != t) {
              void 0 !== t.ref && ((l = t.ref), (h = S.current)),
    ...
    function(e, t, i) {
      (function(t) {
        ...
        var A,
          ...
          b = (A = /[^.]+$/.exec((F && F.keys && F.keys.IE_PROTO) || ""))
            ? "Symbol(src)_1." + A
            : "",
          E = C.toString,
          y = w.hasOwnProperty,
        ...
        (R.prototype.clear = function() {
          ...
          (M.prototype.delete = function(e) {
            var t = this.__data__,
              i = O(t, e);
            return !(
              i < 0 || (i == t.length - 1 ? t.pop() : D.call(t, i, 1), 0)
            );
          }),
        ...
        var z = V(function(e) {
          ...
          return (
            c.test(e) && i.push(""),
            e.replace(u, function(e, t, n, s) {
              i.push(n ? s.replace(d, "$1") : t || e);
            }),
            i
          );
        });
